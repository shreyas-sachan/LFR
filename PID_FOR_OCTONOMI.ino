...
QTRSensorsRC qtr((unsigned char[]){A5, A4, A3, A2, A1, A0, 2, 4},8,2500);  // declaration of sensor pins on the arduino board on which the inputs by the QTR sensors will be given
